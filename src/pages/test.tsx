            ...
            <div className="w-full sm:w-1/2 h-screen relative overflow-hidden bg-[url('frame-36351.jpeg')] bg-cover bg-no-repeat bg-center hidden sm:block">
                ...
                <div className="flex justify-start items-center w-[610.75px] h-[128.58px] absolute left-[72px] top-[513px] gap-[42.85964584350586px]">
                    ...
                    <p className="text-[32px] text-left text-white">
                        <span className="text-[32px] font-bold text-left text-white">Scout</span>
                ...
                <div className="flex justify-start items-end absolute left-[72px] top-[1214px] opacity-[0.88] gap-[312px]">
                    <div className="flex justify-start items-center relative gap-1">
                        ...
                        <p className="w-[130px] text-lg text-left text-white"> ScoutFlair 2024</p>
                    </div>
                </div>
            </div>
            <div className="md:w-1/2 lg:w-2/3 xs:w-full rounded-lg">
                <div
                ...
                >
                    <div className="flex flex-col justify-start items-start relative gap-3">
                        <p className="text-xl md:text-2xl font-bold text-left text-black">Create an account</p>
                        <p className="text-sm md:text-xs font-bold text-left text-black/[0.72]">Please enter your details</p>
                    </div>
                    <Formik
                    ...
                    >
                        {({ errors, touched }) => (
                            <Form onSubmit={handleSubmit} className="w-full md:w-[400px] relative">
                                <div className="w-full md:w-[400px]">
                                    <div className="w-full md:w-[400px] flex flex-row gap-2 mb-6">
                                        <Field
                                            type="text"
                                            name="firstName"
